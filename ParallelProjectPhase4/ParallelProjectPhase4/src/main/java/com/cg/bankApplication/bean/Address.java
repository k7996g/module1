...
public class Address {
	...
	public Address(int addressId, String country, String state, String city, String street, int houseNo) {
		super();
	...
	public Address(String country, String state, String city, String street, int houseNo) {
		super();
		this.country = country;
		this.state = state;
		this.city = city;
